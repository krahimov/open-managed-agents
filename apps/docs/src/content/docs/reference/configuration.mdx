...
| `GITHUB_AUTH_CLIENT_ID` | main | GitHub sign-in for Console |
| `GITHUB_AUTH_CLIENT_SECRET` | main | GitHub sign-in for Console |
| `BETTER_AUTH_API_KEY` | main | Better Auth Infrastructure dashboard/audit-log connection |
| `BETTER_AUTH_API_URL` | main | Optional custom Better Auth Infrastructure API URL |
| `BETTER_AUTH_KV_URL` | main | Optional custom Better Auth Infrastructure KV URL |
